...
namespace Data.Migrations
{
    ...
    [Migration("20220706205026_Update StockPurchase and Stock tables, change 'value' name to 'price' name")]
    partial class UpdateStockPurchaseandStocktableschangevaluenametopricename
    {
